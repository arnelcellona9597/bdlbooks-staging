...
final class WC_Subscribe_To_Newsletter {
	...
	public function define_constants() {
		$this->define( 'WC_NEWSLETTER_SUBSCRIPTION_VERSION', '4.1.1' );
	...
	public function init() {
		...
		// Init blocks.
		\KoiLab\WC_Newsletter_Subscription\Blocks\Blocks::init();
	}
	...
	public function declare_compatibility() {
		if ( class_exists( '\Automattic\WooCommerce\Utilities\FeaturesUtil' ) ) {
			...
			\Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility( 'cart_checkout_blocks', WC_NEWSLETTER_SUBSCRIPTION_FILE, true );
		}
	}
