...
//
    ...
    public function settings_to_wpml()
    {
        ...
        if (function_exists('icl_register_string')) {
            foreach ($validationStrings as $field) {
                $message = wcpa_get_validation_message($field, new stdClass());
                icl_register_string(WCPA_TEXT_DOMAIN, false, $message);
            }
        }
    ...
    public function settings_to_ml_poly()
    {
        ...
        if (function_exists('pll_register_string')) {
            foreach ($validationStrings as $field) {
                $message = wcpa_get_validation_message($field, new stdClass());
                pll_register_string('wcpa_settings_validation_strings_' . $field, $message, WCPA_PLUGIN_NAME);
            }
        }
    }
