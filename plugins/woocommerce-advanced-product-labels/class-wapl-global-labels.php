...
class WAPL_Global_Labels {
	...
	public function __construct() {
		...
		// wp_is_json_request() added due to fatal error in gutenberg when using 'sale products' block
	...
	public function global_label_hook() {
		...
		foreach ( $global_labels as $global_label ) {
			...
			$label['post_title'] = $global_label->post_title; // Added for WPML identification
