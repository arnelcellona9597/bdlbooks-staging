...
class WC_Newsletter_Subscription_Admin {
	...
	public function plugin_row_meta( $links, $file ) {
		...
		$links['docs'] = sprintf(
			...
			esc_url( 'https://woo.com/document/newsletter-subscription/' ),
		...
		$links['support'] = sprintf(
			'<a href="%1$s" aria-label="%2$s" target="_blank">%3$s</a>',
			esc_url( 'https://woo.com/my-account/create-a-ticket?select=18605' ),
			esc_attr_x( 'Open a support ticket at Woo.com', 'aria-label: support link', 'woocommerce-subscribe-to-newsletter' ),
