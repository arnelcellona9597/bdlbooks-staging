...
abstract class WC_Newsletter_Subscription_Provider {
	 ...
	 * @return bool
	 */
	abstract public function validate_credentials( $credentials ); // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.Found
	 ...
	 * @return array
	 */
	public function get_form_fields( $connected ) { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.Found
		return array();
	}
