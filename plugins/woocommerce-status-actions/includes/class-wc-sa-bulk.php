...
if (!class_exists('WC_SA_Bulk')) :
    ...
    class WC_SA_Bulk
    {
        ...
        public static function admin_menu()
        {
            add_submenu_page(
                'woocommerce',
                __('Batch Order Processing', 'wc_point_of_sale'),
                __('Batch Order Processing', 'wc_point_of_sale'),
                'manage_woocommerce',
        ...
        public static function output()
        {
            ...
            <div class="wrap" id="posts-filter">
                <h1 class="wp-heading-inline"><?php _e('Batch Order Processing', 'wc_point_of_sale'); ?></h1>
                ...
                <div class="wp-filter" style="margin-bottom: 15px;">
                    <div class="filter-items">
                        <select id="order-status" style="margin-right: 10px;">
                            ...
                            <optgroup label="<?php _e('Custom statuses', 'woocommerce_status_actions'); ?>">
                                <?php foreach ($order_statuses as $key => $value) { ?>
                                    <?php if (($value->hide == 'yes') || ($value->users_to && !in_array($user_id, $value->users_to))) {
                                        continue;
                                    } ?>
                        ...
                        <button class="button" type="button" id="change_status"
                                style="margin-right: 10px;"><?php _e('Apply', 'wc_point_of_sale'); ?></button>
                        <button class="button" type="button" id="clear-table"
                                style="margin-right: 10px;"><?php _e('Clear Orders', 'wc_point_of_sale'); ?></button>
                        <label for="apply-automatically"
                               style="margin-right: 10px;"><?php _e('Apply Automatically', 'wc_point_of_sale'); ?></label>
                        <input type="checkbox" id="apply-automatically">
                    </div>

                    <form class="search-form" id="search-order-form">
                        <input placeholder="<?php _e('Search orders...', 'wc_point_of_sale'); ?>" id="order-number"
                               class="search" value="" type="search">
                    </form>
                </div>
                <div id="orders-list">
                    ...
                    <table class="wp-list-table widefat fixed striped posts">
                        ...
                        <tr>
                            ...
                            <th scope="col" id="order_title"
                                class="manage-column column-order_title column-primary"><?php _e('Order', 'wc_point_of_sale'); ?></th>
                            <th scope="col" id="order_items"
                                class="manage-column column-order_items"><?php _e('Purchased', 'wc_point_of_sale'); ?></th>
                            <th scope="col" id="shipping_address"
                                class="manage-column column-shipping_address"><?php _e('Ship to', 'wc_point_of_sale'); ?>
                                to
                            </th>
                            <th scope="col" id="order_date"
                                class="manage-column column-order_date sortable desc"><?php _e('Date', 'wc_point_of_sale'); ?></th>
                            <th scope="col" id="order_total"
                                class="manage-column column-order_total sortable desc"><?php _e('Total', 'wc_point_of_sale'); ?></th>
                        </tr>
                        </thead>
                        <tbody id="the-list">
                        </tbody>
                        ...
                        <tr>
                            ...
                            <th scope="col"
                                class="manage-column column-order_items"><?php _e('Purchased', 'wc_point_of_sale'); ?></th>
                            <th scope="col"
                                class="manage-column column-shipping_address"><?php _e('Ship to', 'wc_point_of_sale'); ?></th>
                            <th scope="col"
                                class="manage-column column-order_date sortable desc"><?php _e('Date', 'wc_point_of_sale'); ?></th>
                            <th scope="col"
                                class="manage-column column-order_total sortable desc"><?php _e('Total', 'wc_point_of_sale'); ?></th>
