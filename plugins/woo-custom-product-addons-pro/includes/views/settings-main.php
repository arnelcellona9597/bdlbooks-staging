                                            ...
                                            <ul>
                                                ...
                                                <li class="d-flex align-center">
                                                    <div>
                                                        ...
                                                        <small style="display:block"><?php printf(__('Use %s to add + sign for positive prices', 'wcpa-text-domain'),'{sign}'); ?></small>
                                                    </div>
                                                    <div>
                                                        <span class="wcpa_var_hilight"><?php _e('Preview:', 'wcpa-text-domain');
                                                            echo str_replace('{sign}','+',str_replace(
                                                                'price', 
                                                                wcpa_price(10), 
                                                                htmlspecialchars(wcpa_get_option('field_option_price_format', '(price)'))
                                                                )); ?>
                                                        </span>
                                                    </div>
                                                </li>
                                        ...
                                        <div class="options_group">
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <input type="checkbox" name="enable_cart_item_edit" id="enable_cart_item_edit"
                                                           value="1" <?php checked(wcpa_get_option('enable_cart_item_edit', false)); ?>>
                                                    <label for="enable_cart_item_edit" class="text">
					                                    <?php _e('Enable cart edit', 'wcpa-text-domain'); ?>
                                                        <br>
                                                        <small class="label"><?php _e('Enable the edit options button for items on the cart page', 'wcpa-text-domain'); ?></small>
